...
import com.jgefroh.rms.client.navigation.activities.CreateBookRecordActivity;
...
public class RMSActivityMapper implements ActivityMapper {
    ...
    public Activity getActivity(final Place place) {
        ...
        else if (place instanceof CreateBookRecordPlace) {
            return new CreateBookRecordActivity((CreateBookRecordPlace) place, clientFactory);
        }
